...
process.env.STRIPE_KEY = 'sk_test_51LvsG5FTw1HtxW3fioBH2KdbW5sKBj2z5sxjzTIQAIjUtAxQsHnZ84rTpkfmprUfil005acstkusn35G89zmlbqx00lIWA4yPk';
beforeAll(async () => {
...
global.signin =  (id? : string) => {
  ...
  const payload = {
    // If id is prvided , we give that id else we will generate a random one
